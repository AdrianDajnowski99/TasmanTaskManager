const translations = {
    en: {
        ...
        "help-title": "HELP",
        "help-description": "Welcome to the Task Manager application. To add a new task, select the 'Add new task' operation and fill out the form. To update a task, select the 'Update task' operation and fill out the form. To delete a task, select the 'Delete task' operation and fill out the form. To sort tasks, select the appropriate options from the dropdown lists. Good luck!",
    ...
    pl: {
        ...
        "help-title": "POMOC",
        "help-description": "Witaj w aplikacji Task Manager. Aby dodać nowe zadanie, wybierz operację 'Dodaj nowe zadanie' i wypełnij formularz. Aby zaktualizować zadanie, wybierz operację 'Zaktualizuj zadanie' i wypełnij formularz. Aby usunąć zadanie, wybierz operację 'Usuń zadanie' i wypełnij formularz. Aby posortować zadania, wybierz odpowiednie opcje z list rozwijanych. Powodzenia!",
